...
// Create a party
class GuildParty extends event_1.Event {
    static operateOn(player) {
        if (player.$personalities.isActive('Solo') || player.level < settings_1.SETTINGS.minPartyLevel || !player.guildName)
            return;
